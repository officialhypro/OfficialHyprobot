...
module.exports.setup = (client) => {
    ...
    fs.readdir("./events/", (err, files) => {
        ...
        console.log(chalk.green(`Sucessfully loaded ${jsfiles.length} events from ../events ✔️`));
        jsfiles.forEach((f, i) => {
            require(`../events/${f}`);
        });
    });
    ...
    console.log(chalk.green(`Sucessfully loaded ${cmd_files.length} commands from ../commands ✔️`));
